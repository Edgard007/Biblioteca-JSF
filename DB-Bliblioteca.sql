...
"Pasillo 6",9,2,1,"",13.99,18.99,10,"ender's game.pdf","Libros/PDF/ender'sgame/pdf",1),
...
"Pasillo 6",20,1,"",12.99,16.99,11,"alteredcarbon.jpg","Libros/PDF/altered carbo.PDF",1),
...
insert into club values(1,12,1,"Platino",1);
insert into club values(2,13,2,"Plata",1);
insert into club values(3,11,1,"Bronce",1);
insert into club values(4,10,1,"Oro",1);
insert into club values(5,9,2,"Bronce",1);
insert into club values(6,8,2,"Diamante",1);
insert into club values(7,7,2,"Cobre",1);
insert into club values(8,6,1,"Rubi",1);
insert into club values(9,5,2,"Perla",1);
insert into club values(10,4,1,"Esmeralda",1);
...
(2,"Octavio Paz","Masculino",1914,1998,18,3,"Octavio Irineo Paz Lozano ​ (Ciudad de México, 31 de marzo de 1914-Ib., 19 de abril de 1998) fue un poeta, ensayista y diplomático mexicano, Premio Nobel de Literatura en 1990. Se le considera uno de los más influyentes escritores del siglo XX y uno de los grandes poetas hispanos de todos los tiempos.​ Su extensa obra abarcó géneros diversos, entre los que sobresalieron poemas, ensayos y traducciones.
...
"homero.jpg",1),
(15,"William Shakespeare","Masculino",1564,1616,5,"fue un poeta, dramaturgo y actor inglés, ampliamente considerado como el mejor escritor en inglés y el mejor dramaturgo del mundo. A menudo se le llama poeta nacional de Inglaterra y el Bardo de Avon (o simplemente el Bardo)",
"shakespeare.jpg",1);
